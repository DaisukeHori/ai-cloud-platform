 ...
 * 複数のAIモデルにアクセスできるOpenRouter APIを使用
 */
export class OpenRouterProvider implements AIProvider {
  ...
  readonly availableModels: AIModel[] = [
    ...
    },
    {
      ...
      description: 'Googleの高性能なマルチモーダルモデル。',
      contextWindow: 32000,
    ...
    },
    {
      ...
      description: 'Mistral AIの高性能モデル。効率的で高品質な応答を生成。',
      contextWindow: 32000,
      maxOutputTokens: 2048,
      pricing: {
  ...
  constructor(
    apiKey: string,
    defaultModelId: string = 'anthropic/claude-3-sonnet',
