...
describe('OpenRouterProvider', () => {
  ...
  describe('generateCode', () => {
    ...
    it('should include language and framework in system prompt', async () => {
      ...
      const callArgs = (axios.post as jest.Mock).mock.calls[0][1];
    ...
    it('should handle empty response', async () => {
      ...
      const emptyMessageResult = await provider.generateCode('test prompt');
      expect(emptyMessageResult).toBe('');
    });
  });
  
  describe('improveCode', () => {
    it('should call OpenRouter API with code and instructions', async () => {
  ...
  describe('explainCode', () => {
    it('should call OpenRouter API with code to explain', async () => {
      const code = 'function add(a, b) { return a + b; }';
  ...
  describe('generateTests', () => {
    it('should call OpenRouter API with code to test', async () => {
      const code = 'function add(a, b) { return a + b; }';
  ...
  describe('generateDocumentation', () => {
    it('should call OpenRouter API with code to document', async () => {
      const code = 'function add(a, b) { return a + b; }';
  ...
  describe('suggestArchitecture', () => {
    it('should call OpenRouter API with requirements', async () => {
  ...
  describe('suggestBugFix', () => {
    it('should call OpenRouter API with buggy code and error message', async () => {
      const code = 'function add(a, b) { return a - b; }';
  ...
  describe('suggestOptimization', () => {
    it('should call OpenRouter API with code to optimize', async () => {
  ...
  describe('checkSecurity', () => {
    it('should call OpenRouter API with code to check security', async () => {
  ...
  describe('designAPI', () => {
    it('should call OpenRouter API with API requirements', async () => {
  ...
  describe('designDataModel', () => {
    it('should call OpenRouter API with data model requirements', async () => {
  ...
  describe('custom options', () => {
    it('should use custom model, temperature and max tokens', async () => {
      ...
      expect(callArgs.model).toBe('meta/llama-3-70b-instruct');
